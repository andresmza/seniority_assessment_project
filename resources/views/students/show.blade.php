        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-200 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="overflow-x-auto mx-6 mb-4">
                    <h3 class="font-bold text-lg mb-4"> Courses </h3>
                    @foreach ($courses as $course)
                        <div class="container mt-6" style="display: flex;">
                            <div style="width: 50%">
                                <p class="font-bold mt-4">{{ $course->name }}</p>
                                ...
                                <p class="">Final calification: {{ $course->final_calification ?? 'N/A' }}</p>
