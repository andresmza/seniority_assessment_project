        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-200 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 my-4">
                    <label for="create-teacher" class="btn modal-open">Create course</label>
                </div>
                    ...
                    <table class="table w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><label for="my-modal" data-teacher-id="2"
                            ...
                            <tr>
                                ...
                                <td><label for="my-modal" data-teacher-id="3" class="btn modal-button"
                                        onclick="showModal(3)">Show</label></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
